...
public class VerticalMove : MonoBehaviour
{
	...
	void Start(){
		movement = new Vector2(0, ySens); // on créé un vecteur en 2D qui bouge dans le sens ySens
	}
	...
	void FixedUpdate() {
		...
		{
			rb.MovePosition(rb.position + movement * moveSpeed * Time.fixedDeltaTime); //formule pour faire déplacer l'objet
